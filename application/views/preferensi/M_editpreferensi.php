				...
				<form action="<?= base_url('preferensi/edit') ?>" method="post">
					<div class="modal-body">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="kode_preferensi" value="<?= str_pad($key['kode_preferensi'], 4, 0, STR_PAD_LEFT) ?>" readonly>
						</div>
						<div class="form-group">
							<label for="uraian_preferensi" class="col-form-label">
								Nama Preferensi
							</label>
							<input type="text" class="form-control" name="uraian_preferensi" value="<?= $key['uraian_preferensi'] ?>" required>
						</div>
						<div class="form-group">
							<label for="satuan_preferensi" class="col-form-label">
								Satuan Preferensi
							</label>
							<input type="text" class="form-control" name="satuan_preferensi" value="<?= $key['satuan_preferensi'] ?>" required>
						</div>
						<div class="form-group">
							<label for="harga_preferensi" class="col-form-label">
								Harga Preferensi
							</label>
							<input type="number" class="form-control" name="harga_preferensi" value="<?= $key['harga_preferensi'] ?>" required>
						</div>
					</div>
