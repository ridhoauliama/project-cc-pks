						...
						<div class="card shadow">
							<div class="card-body">
								<div class="toolbar row mb-3">
									<div class="col">
										<div class="row m-0">
											<a href="#" class="btn btn-primary ml-2 d-md-table" data-toggle="modal" data-target="#tambahPreferensi">
												<i class="fe fe-plus" aria-hidden="true"></i>&nbsp; Tambah Preferensi
											</a>
											<a href="#" class="btn btn-info ml-2 d-md-table" data-toggle="modal" data-target="#">
									...
									<tbody class="text-center">
										<?php foreach ($preferensi as $key) { ?>
											<tr>
												<td>
													<?php
													if ($key['kode_preferensi'] < 11) {
													?>
														<i class="fe fe-lock text-danger"></i>
													<?php
													}
													?>
													<?= str_pad($key['kode_preferensi'], 4, 0, STR_PAD_LEFT) ?>
												</td>
												<td><?= $key['uraian_preferensi'] ?></td>
												<td>
													<?php
													if ($key['kode_preferensi'] > 10) {
													?>
