				...
				<form action="<?= base_url('costcenter/tambah_beban') ?>" method="post">
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<br>
							<input type="radio" name="status" value="1" required><span class="ml-1 mr-3" onclick="hitung_total()">Lunas</span>
					...
					<form action="<?= base_url('costcenter/ubah_beban') ?>" method="post">
						<div class="modal-body">
							...
							<div class="form-group">
								...
								<input type="number" class="form-control" name="total_biaya_transaksi" id="total_biaya_transaksi<?= $key['id_transaksi'] ?>" value="<?= $key['total_biaya_transaksi'] ?>" readonly required>
							</div>
							<div class="form-group">
								<label for="status" class="col-form-label">Status Pembayaran </label>
								<br>
