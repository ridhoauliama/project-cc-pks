...
<?php foreach ($cc as $key) { ?>
	<div class="modal fade" id="editCC<?= $key['kode_cc'] ?>" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
				...
				<form action="<?= base_url('dashboard/edit') ?>" method="post">
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="kode_cc" value="<?= $key['kode_cc'] ?>" readonly required>
						</div>
						<div class="form-group">
							<label for="nama_cc" class="col-form-label">
								Nama Cost Center
							</label>
							<input type="text" class="form-control" name="nama_cc" value="<?= $key['nama_cc'] ?>" required>
						</div>
						<div class="form-group">
							<label for="mulai_cc" class="col-form-label">
								Tanggal Mulai
							</label>
							<input type="date" class="form-control" name="mulai_cc" value="<?= $key['mulai_cc'] ?>" required>
						</div>
						<div class="form-group">
							<label for="akhir_cc" class="col-form-label">
								Tanggal Berakhir
							</label>
							<input type="date" class="form-control" name="akhir_cc" value="<?= $key['akhir_cc'] ?>" required>
						</div>
					</div>
