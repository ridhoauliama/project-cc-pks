											...
											<tr>
												...
												<td>
													...
													<div class="dropdown-menu dropdown-menu-right">
														...
														<a class="dropdown-item text-primary" href="#" data-toggle="modal" data-target="#ubahBeban<?= $key['id_transaksi'] ?>"><span class="fe fe-edit fe-16"></span>
															Ubah
														</a>
			...
			<div class="modal-content">
				...
				<form action="<?= base_url('costcenter/tambah_beban') ?>" method="post">
					<div class="modal-body">
						<input type="hidden" name="costcenter" value="<?= $this->session->userdata('costcenter') ?>" required>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="faktur" placeholder="" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="number" class="form-control" name="total_biaya_transaksi" min="0" required>
						</div>
						<div class="form-group">
					...
					<form action="<?= base_url('costcenter/ubah_beban') ?>" method="post">
						<div class="modal-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="faktur" value="<?= $key['no_faktur'] ?>" required>
							</div>
							<div class="form-group">
								<label for="uraian" class="col-form-label">Tanggal </label>
								<input type="date" class="form-control" name="tanggal" value="<?= $key['tanggal_faktur'] ?>" required>
							</div>
							<div class=" form-group">
								<label for="total_biaya_transaksi" class="col-form-label">Jumlah </label>
								<input type="number" class="form-control" name="total_biaya_transaksi" value="<?= $key['total_biaya_transaksi'] ?>" min="0" required>
							</div>
							<div class=" form-group">
								<label for="keterangan" class="col-form-label">Keterangan </label>
								<input type="text" class="form-control" name="keterangan" value="<?= $key['keterangan'] ?>" required>
							</div>
							<div class="form-group">
								<label for="status" class="col-form-label">Status Pembayaran </label>
								<br>
