...
<?php foreach ($cc as $key) { ?>
	<div class="modal fade" id="detailCC<?= $key['kode_cc'] ?>" tabindex="-1" role="dialog" aria-labelledby="verticalModalTitle" aria-hidden="true">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<ul class="list-group">
						...
						<li class="list-group-item d-flex justify-content-between align-items-center">
							Tanggal Mulai
							<span class="badge badge-primary badge-pill"><?= date('d-m-Y', strtotime($key['mulai_cc'])) ?></span>
						</li>
						<li class="list-group-item d-flex justify-content-between align-items-center">
							Tanggal Berakhir
							<span class="badge badge-primary badge-pill"><?= date('d-m-Y', strtotime($key['akhir_cc'])) ?></span>
						</li>
					</ul>
				</div>
