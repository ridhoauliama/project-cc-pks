											...
											<tr>
												...
												<td>
													...
													<div class="dropdown-menu dropdown-menu-right">
														...
														<a class="dropdown-item text-primary" href="#" data-toggle="modal" data-target="#ubahLainnya<?= $key['id_transaksi'] ?>"><span class="fe fe-edit fe-16"></span>
															Ubah
														</a>
				...
				<div class="modal-content">
					...
					<form action="<?= base_url('costcenter/ubah_pendapatan') ?>" method="post">
						<div class="modal-body">
							...
							<div class=" form-group">
								<label for="nominal" class="col-form-label">Jumlah </label>
								<input type="number" class="form-control" name="nominal" value="<?= $key['total_biaya_transaksi'] ?>" min="0" required>
							</div>
							<div class="form-group">
								<label for="status" class="col-form-label">Status Pembayaran </label>
								<br>
