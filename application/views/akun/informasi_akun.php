				...
				<div class="my-4">
					...
					<form class="mb-4" id="form_biodata" method="post" action="<?= base_url('akun/ubah_biodata') ?>" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="nama" name="nama" value="<?= $akun['nama_pengguna'] ?>" placeholder="Nama Anda" readonly required>
						</div>
						<div class="form-group">
							<label for="alamat">Alamat</label>
							<input type="text" class="form-control" id="alamat" name="alamat" value="<?= $akun['alamat'] ?>" placeholder="Alamat Anda" readonly required>
						</div>
						<div class="form-group">
							<label for="no_hp">No. Handphone</label>
							<input type="number" class="form-control" id="hp" name="hp" value="<?= $akun['no_hp'] ?>" placeholder="Tanpa +62 atau 0" readonly required>
						</div>
						<hr class="my-4">
