										...
										<form action="<?= base_url('akun/ubah_password') ?>" method="post">
											...
											<div class="col-md-12 mb-4">
												<div class="form-group">
													...
													<input type="password" class="form-control" id="pl" name="pl" required>
												</div>
												<div class="form-group">
													<label for="inputPassword5">Password Baru</label>
													<input type="password" class="form-control" id="pb1" name="pb1" required>
												</div>
												<div class="form-group">
													<label for="inputPassword6">Konfirmasi Password</label>
													<input type="password" class="form-control" id="pb2" name="pb2" required>
												</div>
										...
										<form action="<?= base_url('akun/ubah_pertanyaan') ?>" method="post">
											<div class="col-md-12 mb-4">
												...
												<div class="form-group">
													...
													<select class="form-control" id="keamanan_1" required>
														<option value=""></option>
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="jawaban_1" name="jawaban_1" required>
												</div>
												<div class="div mt-4">
												...
												<div class="form-group">
													...
													<select class="form-control" id="keamanan_2" required>
														<option value=""></option>
														<?php foreach ($q as $key) { ?>
															<option value="<?= $key['id'] ?>" <?php
																								if ($key['id'] == $q2) {
												...
												<div class="form-group">
													<label for="jawaban_1">Jawaban</label>
													<input type="text" class="form-control" id="jawaban_2" name="jawaban_2" required>
												</div>
