			...
			<form action="<?= base_url('kontak/tambah') ?>" method="post">
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="nama" placeholder="Nama Kontak" required>
					</div>
					<div class="form-group">
						<label for="alamat_kontak" class="col-form-label">
							Alamat
						</label>
						<input type="text" class="form-control" name="alamat" placeholder="Alamat Kontak" required>
					</div>
					<div class="form-group">
